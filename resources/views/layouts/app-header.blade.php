    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="flex items-center gap-2 xl:hidden">
                <img src="/images/logo/logo_kalsel.svg" alt="Logo Kalsel" class="size-9 object-contain" />
                <span class="text-xl font-bold text-gray-900 dark:text-white">Kalsel</span>
            </a>
            ...
            {{-- Pencarian global disembunyikan karena belum digunakan. --}}
        </div>
